...
let facultyWrapper = document.getElementById('faculty-wrapper-en')
        ...
        for (let i = 0; i < res.length; i++) {
            ...
            fetchStaff(item.staffEnum, item.id)
                .then(res=>{
                    ...
                    cardHeader.innerText = item.nameEn
                    ...
                    name.innerText = staff===null? '': staff.fioEn

                    let position = document.createElement('p')
                    position.classList.add('font-italic')
                    position.innerText= staff===null? '': staff.academicDegreeEn
                    ...
                    acceptanceSpan.innerText = staff===null? '': staff.acceptanceEn
