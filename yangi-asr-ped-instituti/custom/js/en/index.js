...
let slideNews = document.getElementById('slide-news-en')
let slideEvents = document.getElementById('slide-events-en')
let slideDocs = document.getElementById('slide-docs-en')
let sliderBody = document.getElementById('slider-body-en')

let newsWrapper = document.getElementById('news-wrapper-en')

let faculties = document.getElementById('faculties-en')
let specialities = document.getElementById('specialities-en')
let students = document.getElementById('students-en')
let teachers = document.getElementById('teachers-en')
let partners = document.getElementById('partners-en')
...
function setToBody(promise, href, key) {
    promise.then(res => {
        ...
        for (let i = 0; i < res.length; i++) {
            ...
            span.innerText = res[i].titleEn
            img.src = "../../assets/LOGO-SVG.svg"
            a.appendChild(img)
            a.appendChild(span)
            const div = document.createElement("div")
            a.href = href === "" ? res[i].linkEn : href
            if (key !== "")
                a.onclick = () => {
