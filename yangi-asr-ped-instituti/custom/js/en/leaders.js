...
let leaderWrapper = document.getElementById('leaders-en')
        ...
        fetchStaff("LEADERSHIP")
            .then(staff => {
                ...
                for (let i = 0; i < staff.length; i++) {
                    ...
                    cardHeader.innerText = result.nameEn
                    ...
                    name.innerText = staffItem === null ? '' : staffItem.fioEn

                    let position = document.createElement('p')
                    position.classList.add('font-italic')
                    position.innerText = staffItem === null ? '' : staffItem.academicDegreeEn
                    ...
                    acceptanceSpan.innerText = staffItem === null ? '' : staffItem.acceptanceEn
