...
let leaderWrapper = document.getElementById('leaders-oz')
        ...
        fetchStaff("LEADERSHIP")
            .then(staff => {
                ...
                for (let i = 0; i < staff.length; i++) {
                    ...
                    cardHeader.innerText = result.nameOz
                    ...
                    name.innerText = staffItem === null ? '' : staffItem.fioOz

                    let position = document.createElement('p')
                    position.classList.add('font-italic')
                    position.innerText = staffItem === null ? '' : staffItem.academicDegreeOz
                    ...
                    acceptanceSpan.innerText = staffItem === null ? '' : staffItem.acceptanceOz
