...
let facultyWrapper = document.getElementById('faculty-wrapper-oz')
        ...
        for (let i = 0; i < res.length; i++) {
            ...
            fetchStaff(item.staffEnum, item.id)
                .then(res=>{
                    ...
                    cardHeader.innerText = item.nameOz
                    ...
                    name.innerText = staff===null? '': staff.fioOz

                    let position = document.createElement('p')
                    position.classList.add('font-italic')
                    position.innerText= staff===null? '': staff.academicDegreeOz
                    ...
                    acceptanceSpan.innerText = staff===null? '': staff.acceptanceOz
