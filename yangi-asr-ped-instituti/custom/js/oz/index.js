...
let slideNews = document.getElementById('slide-news-oz')
let slideEvents = document.getElementById('slide-events-oz')
let slideDocs = document.getElementById('slide-docs-oz')
let sliderBody = document.getElementById('slider-body-oz')

let newsWrapper = document.getElementById('news-wrapper-oz')

let faculties = document.getElementById('faculties-oz')
let specialities = document.getElementById('specialities-oz')
let students = document.getElementById('students-oz')
let teachers = document.getElementById('teachers-oz')
let partners = document.getElementById('partners-oz')
...
function setToBody(promise, href, key) {
    promise.then(res => {
        ...
        for (let i = 0; i < res.length; i++) {
            ...
            span.innerText = res[i].titleOz
            img.src = "../../assets/LOGO-SVG.svg"
            a.appendChild(img)
            a.appendChild(span)
            const div = document.createElement("div")
            a.href = href === "" ? res[i].linkOz : href
            if (key !== "")
                a.onclick = () => {
