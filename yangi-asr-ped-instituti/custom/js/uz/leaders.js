...
let leaderWrapper = document.getElementById('leaders-uz')
        ...
        fetchStaff("LEADERSHIP")
            .then(staff => {
                ...
                for (let i = 0; i < staff.length; i++) {
                    ...
                    cardHeader.innerText = result.nameUz
                    ...
                    name.innerText = staffItem === null ? '' : staffItem.fioUz

                    let position = document.createElement('p')
                    position.classList.add('font-italic')
                    position.innerText = staffItem === null ? '' : staffItem.academicDegreeUz
                    ...
                    acceptanceSpan.innerText = staffItem === null ? '' : staffItem.acceptanceUz
